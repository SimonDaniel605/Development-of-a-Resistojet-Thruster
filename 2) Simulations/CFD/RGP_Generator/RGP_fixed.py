# =============================================================================
# RGP Generator for ANSYS Fluent
#
# Original Author:
#   Shrey Sahai
#
# Original Repository:
#   https://github.com/ShreySahai/RGPGenerator
#
# Modifications:
#   - Updated for compatibility with CoolProp 8.x.
#   - Fixed AbstractState construction for the current CoolProp API.
#
# Modified by:
#   Simon Daniel
...
class AbstractState(CP.AbstractState):
    def __new__(cls, backend, fluid):
        # Newer CoolProp/nanobind builds require positional constructor args.
        return super().__new__(cls, backend, fluid)

    def __init__(self, backend, fluid):
        # The underlying C++ AbstractState is already initialized in __new__.
        self.initPrint()
        self.fluidname = fluid
